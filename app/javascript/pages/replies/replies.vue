  ...
  <div id="title-show" class="relative">
    <div class="container p-10 m-10 mx-auto bg-blue-100 rounded-md text-blue-900 rounded-md rounded-md">
      ...
      <ul class="h-64 overflow-auto">
        ...
        >
            {{ reply.id }} - {{ reply.reply_title }} - {{ reply.user_name }} - {{ reply.favorite }}
          <button @click="handleDeleteReply(reply)">削除</button>
        </li>
    ...
    <div class="container mx-auto">
      <form class="md:flex bg-gray-200 absolute bottom-0 left-0 w-screen p-3 justify-around">
        ...
        <div class="md:flex md:items-center md:mb-0 mb-6">
          <div>
            <button class="shadow bg-blue-500 hover:bg-blue-400 focus:shadow-outline focus:outline-none text-white font-bold py-2 px-4 rounded" type="button" @click="handleCreateNewReply">
              回答
            </button>
          </div>
        </div>
